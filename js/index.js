// Book Class: Properties Title and Author
// Bookshelf Class: Maintains array of Books & add Books
// Should be able to pull data from book-data.js
// exporting variables and function: 
// export {properties};
// importing variables and functions: 
// import {properties} from "./book-data.js";
...
// Wasn't able to use import/export to connect both JS files. First attempt is listed below; 
// leaving it there to get some clarification after the assement is graded. 
// class UI {
//     static displayBooks() {
//         const StoredBooks = import { author, language, subject, title } from "./book.data.js";
...
// filterInput.addEventListener("keyup", filterAuthor, filterTitle);

// Wasn't able to connect my Title and Author to my Search button.
// Line 1756 - is supposed to pull blank searches if enduser isn't typing searchable characters in the Table but instead the list of books disappear. 

// function filterAuthor(){
//     let filterBooks = document.getElementById("book-list").value.toUpperCase();
//     let tr = filterBooks.querySelectorAll("tr");
//         for (let i = 0; i < tr.length; i++){
//             let a = tr[i].getElementsByTagName("tr")[0];
